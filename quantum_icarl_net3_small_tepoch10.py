...
# 从文件加载
import pickle
with open("results/list/CIFAR100_ICaRL_qml_net3_qbit4_qdepth4_tepoch10.pkl", "rb") as f:
...
plt.grid(True)
plt.legend("CIFAR100_ICaRL_qml_net3_qbit4_qdepth4_tepoch10_loss")
plt.tight_layout()
plt.savefig("results/figs/CIFAR100_ICaRL_qml_net3_qbit4_qdepth4_tepoch10_loss.png")
...
plt.xticks(range(1, len(x) + 1))  # 设置 x 轴刻度
plt.grid(True)
plt.legend("CIFAR100_ICaRL_qml_net3_qbit4_qdepth4_tepoch10_acc")
plt.tight_layout()
plt.savefig("results/figs/CIFAR100_ICaRL_qml_net3_qbit4_qdepth4_tepoch10_acc.png")
...
plt.grid(True)
plt.legend("CIFAR100_ICaRL_qml_net3_qbit4_qdepth4_tepoch10_forget")
plt.tight_layout()
plt.savefig("results/figs/CIFAR100_ICaRL_qml_net3_qbit4_qdepth4_tepoch10_forget.png")
