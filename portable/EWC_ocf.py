...
ewc_plugin = EWCPlugin(
    ...
    mode='separate',        # 使用 online 模式可累积 Fisher 信息
    # decay_factor=1,     # Fisher 信息随任务递减的比例
...
file_path = "/home/yangz2/code/quantum_cl/results/list/splitminist_EWC_ocf_qbit10_qdepth10.pkl"
