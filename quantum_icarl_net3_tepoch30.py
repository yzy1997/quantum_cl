...
# 存储到文件
with open("results/list/CIFAR100_ICaRL_qml_net3_qbit4_qdepth6_tepoch30.pkl", "wb") as f:
...
plt.legend()
plt.tight_layout()
plt.savefig("results/figs/CIFAR100_ICaRL_qml_net3_qbit4_qdepth6_tepoch30_loss.png")
...
plt.legend()
plt.tight_layout()
plt.savefig("results/figs/CIFAR100_ICaRL_qml_net3_qbit4_qdepth6_tepoch30_acc.png")
...
plt.legend()
plt.tight_layout()
plt.savefig("results/figs/CIFAR100_ICaRL_qml_net3_qbit4_qdepth6_tepoch30_forget.png")
