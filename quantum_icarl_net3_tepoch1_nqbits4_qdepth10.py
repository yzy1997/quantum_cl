...
# 存储到文件
with open("results/list/CIFAR100_ICaRL_qml_net3_qbit12_qdepth6_tepoch1.pkl", "wb") as f:
...
# 从文件加载
import pickle
with open("results/list/CIFAR100_ICaRL_qml_net3_qbit12_qdepth6_tepoch1", "rb") as f:
...
plt.legend()
plt.tight_layout()
plt.savefig("results/figs/CIFAR100_ICaRL_qml_net3_qbit12_qdepth6_tepoch1_loss.png")
...
plt.legend()
plt.tight_layout()
plt.savefig("results/figs/CIFAR100_ICaRL_qml_net3_qbit12_qdepth6_tepoch1_acc.png")
...
plt.legend()
plt.tight_layout()
plt.savefig("results/figs/CIFAR100_ICaRL_qml_net3_qbit12_qdepth6_tepoch1_forget.png")
